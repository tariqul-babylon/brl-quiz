...
@section('content')
    <div class="exam-container">
        ...
        <div class="exam-meta">
            ...
            <div class="meta-item">
                <i>💯</i>
                <div>
                    <strong>Total Marks:</strong> {{ $exam->full_mark ?? '' }}
                </div>
            </div>
            <div class="meta-item">
                <i>❓</i>
        ...
        <div class="instructions">
            ...
            {!! $exam->instruction
                ? $exam->instruction
                : '<p class="text-danger">The exam will automatically submit when the time is up.</p>' !!}
        </div>
    ...
    <script>
        const startDate = new Date("{{ \Carbon\Carbon::parse($exam->start_at)->toIso8601String() }}");
        const endDate = new Date("{{ \Carbon\Carbon::parse($exam->end_at)->toIso8601String() }}");
