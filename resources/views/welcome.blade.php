...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <p>Skill Shoper provides comprehensive online testing solutions to help you assess and improve your
                knowledge in various domains.</p>
            <div class="hero-btns">
    ...
    <section class="features">
        <div class="container">
            <div class="section-title">
                ...
                <p>Our platform offers cutting-edge features designed to enhance your learning and testing experience.
                </p>
            </div>
        ...
        <div class="container">
            ...
            <div class="testimonial-grid">
                <div class="testimonial-card">
                    <p class="testimonial-text">"Skill Shoper helped me prepare for my certification exam. The practice
                        tests were incredibly similar to the real thing, and I passed with flying colors!"</p>
                ...
                <div class="testimonial-card">
                    <p class="testimonial-text">"As a hiring manager, I recommend Skill Shoper to all candidates. The
                        certification tests provide reliable proof of a candidate's skills."</p>
                    <div class="testimonial-author">
                ...
                <div class="testimonial-card">
                    <p class="testimonial-text">"The progress tracking feature is amazing. I can see exactly which areas
                        I need to improve, and the platform suggests relevant tests to strengthen my weak points."</p>
                    <div class="testimonial-author">
