                ...
                <form action="{{ route('exams.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row row-cols-3 g-3">
                        ...
                        <div>
                            ...
                            <input type="text" id="exam_start_time" name="exam_start_time" class="form-control @error('exam_start_time') is-invalid @enderror" value="{{ old('exam_start_time') }}">
                        ...
                        <div>
                            ...
                            <input type="text" id="exam_end_time" name="exam_end_time" class="form-control @error('exam_end_time') is-invalid @enderror" value="{{ old('exam_end_time') }}">
                            @error('exam_end_time')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <input type="number" name="negative_mark" class="form-control" step="0.01" value="{{ old('negative_mark') }}">
                        </div>

                        <div>
                            <label>Duration</label>
                            <div class="input-group">
                                <input type="number" name="duration_hours" class="form-control" min="0" max="23" value="{{ old('duration_hours') }}">
                                <span class="input-group-text">Hour</span>
                                <input type="number" name="duration_minutes" class="form-control" min="0" max="59" value="{{ old('duration_minutes') }}">
                        ...
                        @foreach([
                            ...
                            <div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="{{ $boolean }}" id="{{ $boolean }}" {{ old($boolean) ? 'checked' : '' }}>
